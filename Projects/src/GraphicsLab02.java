...
public class GraphicsLab02 extends Applet
{
	...
	g.drawRect(10,10,980,630); //starter rectangle
	
		for(int i = 1; i < 49; i++) { //49 increments
			x1 = 10 + (i * 20); //x increments 980/49 -> 20
			y1 = 640;
			x2 = 990;
			y2 = 640 - (13 * i); //y decrements 630/49 -> round to 13
